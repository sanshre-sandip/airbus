...
<body>
  ...
  <main class="min-h-screen flex items-center justify-center pt-24 px-6">
    <div class="max-w-md w-full glass-card p-8 rounded-2xl">
      ...
      <?php endif; ?>
      <?php if ($success): ?>
        <div class="mb-4 text-sm text-green-400 bg-green-900/10 p-3 rounded"><?php echo htmlspecialchars($success); ?>
        </div>
      <?php endif; ?>
      ...
      <form action="" method="POST" class="space-y-4">
        ...
        <p class="text-center text-sm text-gray-400 mt-3">Already have an account? <a href="login.php"
            class="text-purple-300 hover:underline">Login</a></p>
      </form>
    </div>
  </main>
