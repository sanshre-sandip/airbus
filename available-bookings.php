        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          <?php while ($row = $result->fetch_assoc()): ?>
            <div class="glass-card rounded-2xl p-6">
              ...
              <p class="text-gray-400 mb-1">🚌 Bus No: <span
                  class="text-gray-200"><?php echo htmlspecialchars($row['bus_number']); ?></span></p>
              <p class="text-gray-400 mb-1">📍 From: <span
                  class="text-gray-200"><?php echo htmlspecialchars($row['from_location']); ?></span></p>
              <p class="text-gray-400 mb-1">🎯 To: <span
                  class="text-gray-200"><?php echo htmlspecialchars($row['to_location']); ?></span></p>
              <p class="text-gray-400 mb-1">⏰ Departure: <span
                  class="text-gray-200"><?php echo date('h:i A', strtotime($row['departure_time'])); ?></span></p>
              <p class="text-gray-400 mb-1">🏁 Arrival: <span
                  class="text-gray-200"><?php echo date('h:i A', strtotime($row['arrival_time'])); ?></span></p>
              <p class="text-gray-400 mb-1">💰 Fare: <span class="text-gray-200">Rs.
                  <?php echo number_format($row['fare'], 2); ?></span></p>
              <p class="text-gray-400 mb-6">🪑 Available Seats: <span
                  class="text-gray-200"><?php echo max($row['available_seats'], 0); ?></span></p>
